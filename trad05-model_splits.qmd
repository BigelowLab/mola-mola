...
Now we can proceed, much as we did with our [basic model](trad03-basic_modeling.qmd), but using only the training portion of the data. Note that this will be model version `v3.0`.
